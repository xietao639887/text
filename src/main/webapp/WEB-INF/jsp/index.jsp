            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-default" type="button"
                            onclick="location.href='toUpdata?studentID=${i.studentID}'">编辑
                    </button>
    ...
    <div id="a">
        <nav aria-label="...">
            <ul class="pagination">
                ...
                <c:if test="${page.pageIndex!=1}">
                    <li>
                        <a href="listStudens?pageIndex=${page.pageIndex-1}" aria-label="Previous">
                ...
                <c:forEach begin="1" end="${page.totalPage}" var="i">
                    ...
                    <c:if test="${i!=page.pageIndex}">
                        <li><a href="listStudens?pageIndex=${i}">${i}</a></li>
                    </c:if>
                </c:forEach>
                ...
                <c:if test="${page.pageIndex!=page.totalPage}">
                    <li>
                        <a href="listStudens?pageIndex=${page.pageIndex+1}" aria-label="Next">
